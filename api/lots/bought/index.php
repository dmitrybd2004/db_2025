...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        global $conn;
        $query = "SELECT * FROM lot WHERE buyer_name = ?";
        $query = "SELECT lot.*, refunds.processed FROM lot LEFT JOIN refunds ON lot.item_id = refunds.item_id AND refunds.processed = 0 WHERE lot.buyer_name = ?";
        ...
        error_log("Error fetching bought items: " . $e->getMessage());
